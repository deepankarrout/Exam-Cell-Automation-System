...
$status=1;
$sql="INSERT INTO  tblsubjectcombination(ClassId,SubjectId,fid,status) VALUES(:class,:subject,:teacher,:status)";
...
<?php $sql = "SELECT tblclasses.id, tblclasses.semid, tblclasses.Section, tblsemester.id, tblsemester.semname from tblclasses join tblsemester on tblsemester.id=tblclasses.semid";
$query = $dbh->prepare($sql);
$query->execute();
...
foreach($results as $result)
{   ?>
                                                                <option value="<?php echo htmlentities($result->id); ?>"><?php echo htmlentities($result->e_name); ?>&nbsp;( Id-<?php echo htmlentities($result->e_id); ?> )</option>
<?php }} ?>
                                                            </select>
                                                        </div>
                                                    </div>

...
$sql="update  tblsubjects set SubjectName=:subjectname,SubjectCode=:subjectcode,credits=:credit where id=:sid";
$query = $dbh->prepare($sql);
$query->bindParam(':subjectname',$subjectname,PDO::PARAM_STR);
$query->bindParam(':subjectcode',$subjectcode,PDO::PARAM_STR);
$query->bindParam(':credit',$subjectcredit,PDO::PARAM_STR);
...
{   ?>                                               
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="text" name="subjectcrd" class="form-control" value="<?php echo htmlentities($result->credits);?>" id="subjectcrd" placeholder="Subject Credit" required="required">
                                                        </div>
                                                    </div>
                                                    <?php }} ?>

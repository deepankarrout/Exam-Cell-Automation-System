...
<?php $sql = "SELECT tblclasses.id, tblclasses.semid, tblclasses.Section, tblclasses.CreationDate, tblsemester.id, tblsemester.semname from tblclasses join tblsemester on tblsemester.id=tblclasses.semid";
...
<tr>
 <td><?php echo htmlentities($cnt);?></td>
                                                            <td><?php echo htmlentities($result->semname);?> SEMESTER</td>

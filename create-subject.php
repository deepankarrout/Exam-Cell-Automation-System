...
$subjectcredit=$_POST['subjectcrd'];
$subtype=$_POST['subtype'];
$sql="INSERT INTO  tblsubjects(SubjectName,SubjectCode,credits,subtype) VALUES(:subjectname,:subjectcode,:credits,:subtype)";
$query = $dbh->prepare($sql);
$query->bindParam(':subjectname',$subjectname,PDO::PARAM_STR);
$query->bindParam(':subjectcode',$subjectcode,PDO::PARAM_STR);
$query->bindParam(':credits',$subjectcredit,PDO::PARAM_STR);
$query->bindParam(':subtype',$subtype,PDO::PARAM_STR);
$query->execute();
                                        ...
                                        <?php } ?>
                                                <form class="form-horizontal" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="text" name="subjectcrd" class="form-control" id="subjectcrd" placeholder="Subject Credit" required="required">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <select name="subtype" class="form-control" id="subtype" required="required">
